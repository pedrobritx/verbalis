# Phase 4.3 — Postgres persistence loop

You are implementing **Phase 4.3** of the Verbalis Translation IDE revamp.
...
- If scope overflows the session: ship the core slice green, append the remainder as Phase 4.3.1 to STATUS and ROADMAP §4, and say so in the PR body.
